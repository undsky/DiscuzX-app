<template>
	<view>
		...
		<swiper class="swiper" :current="currentIndex" @transition="transition" @animationfinish="animationfinish">
			...
			<swiper-item>
				<scroll-view class="sv" scroll-y="true" @scrolltolower="loadMorePhoto">
									...
									<view class="cu-list menu-avatar">
										<view class="cu-item">
											...
											<view class="content flex-sub">
												...
												<view class="text-gray text-sm flex justify-between">{{ item.last_reply_date }}</view>
											</view>
										</view>
									</view>
									<view class="padding-lr-xs margin-top-xs"><u-lazy-load border-radius="10" :image="item.pic_path" :index="index"></u-lazy-load></view>
