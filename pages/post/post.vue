				...
				<view class="uni-padding-wrap response">
					<block v-if="!recording && !playing && !hasRecord">
						...
						<view class="page-body-buttons">
							...
							<view class="page-body-button" @click="startRecord"><image class="audio-image" src="../../static/record.png"></image></view>
							<view class="page-body-button"></view>
						</view>
					</block>
					<block v-if="recording === true">
						...
						<view class="page-body-buttons">
							<view class="page-body-button"></view>
							<view class="page-body-button" @click="stopRecord"><view class="button-stop-record"></view></view>
							<view class="page-body-button"></view>
						</view>
					</block>
					<block v-if="hasRecord === true && playing === false">
						...
						<view class="page-body-buttons">
							<view class="page-body-button" @click="playVoice"><image class="audio-image" src="../../static/play.png"></image></view>
							<view class="page-body-button" @click="clear"><image class="audio-image" src="../../static/trash.png"></image></view>
						</view>
					</block>
					<block v-if="hasRecord === true && playing === true">
						...
						<view class="page-body-buttons">
							<view class="page-body-button" @click="stopVoice"><image class="audio-image" src="../../static/stop.png"></image></view>
							<view class="page-body-button" @click="clear"><image class="audio-image" src="../../static/trash.png"></image></view>
						</view>
					</block>
				</view>
			...
			<u-form-item label-position="top" label="上传视频" prop="audio" label-width="150">
				<view class="uni-padding-wrap response">
					...
					<template v-else>
						...
						<view class="page-body-buttons">
							<view class="page-body-button" @click="clearVideo()"><image class="audio-image" src="../../static/trash.png"></image></view>
						</view>
					</template>
				</view>
			</u-form-item>
		</u-form>
		<view class="margin-top-lg padding-bottom-lg"><u-button throttleTime="1000" type="warning" @click="submit">发布</u-button></view>
