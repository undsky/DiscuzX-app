	...
	<view>
		...
		<scroll-view scroll-y="true" class="wrapper">
			<view class="u-flex user-box u-p-l-30 u-p-r-20 u-p-b-30 margin-top">
				<view class="u-m-r-10"><u-avatar size="140"></u-avatar></view>
				<view class="u-flex-1">
					<template v-if="user">
			...
			<view class="u-m-t-20">
				<u-cell-group :border="false">
					...
					<u-cell-item @click="$util.helper.goto('./following/following', true)" icon="bookmark" title="我的关注"></u-cell-item>
			...
			<view class="u-m-t-20">
				<u-cell-group :border="false"><u-cell-item @click="$util.helper.goto('../setting/setting')" icon="setting" title="设置"></u-cell-item></u-cell-group>
			</view>
		</scroll-view>
